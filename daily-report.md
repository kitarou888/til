...
1/24(水) システム設計の面接試験 P.195〜
1/25(木) ブルーベリ本輪読会 5.1.6〜(アクセシビリティ修飾子)、システム設計の面接試験６章振り返り P.205〜(ニュースフィードシステム)
1/26(金) 現場 Rails 輪読会 P.299〜(メール機能)、システム設計の面接試験 P.211〜(ニュースフィードシステム)
